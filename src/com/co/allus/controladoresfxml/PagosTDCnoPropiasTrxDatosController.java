 ...
 */
public class PagosTDCnoPropiasTrxDatosController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        assert Box_pago_dolar != null : "fx:id=\"Box_pago_dolar\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxDatos.fxml'.";
        assert OtroValorDolar != null : "fx:id=\"OtroValorDolar\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxDatos.fxml'.";
        assert OtroValorPesos != null : "fx:id=\"OtroValorPesos\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxDatos.fxml'.";
        assert PagoMinDolar != null : "fx:id=\"PagoMinDolar\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxDatos.fxml'.";
        assert PagoMinPesos != null : "fx:id=\"PagoMinPesos\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxDatos.fxml'.";
        assert PagoTotalDolar != null : "fx:id=\"PagoTotalDolar\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxDatos.fxml'.";
        assert PagoTotalPesos != null : "fx:id=\"PagoTotalPesos\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxDatos.fxml'.";
        assert ValorDolares != null : "fx:id=\"ValorDolares\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxDatos.fxml'.";
        assert ValorPesos != null : "fx:id=\"ValorPesos\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxDatos.fxml'.";
        assert cancelar != null : "fx:id=\"cancelar\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxDatos.fxml'.";
        assert continuar_op != null : "fx:id=\"continuar_op\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxDatos.fxml'.";

        this.resources = rb;
        this.location = url;
    }

    public void mostrarTDCNopropiasTrxDatos(final InfoDatosTdcPropia infoDatos) {
            ...
            Platform.runLater(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        final URL location = getClass().getResource("/com/co/allus/vistas/PagosTDCnoPropiasTrxDatos.fxml");
...
//            ex.printStackTrace();
    ...
    void cancel_op(ActionEvent event) {
        Atlas.getVista().mostrarMenuPagosTDCnoPropia("PAGO-TDC");
    }
    ...
    void continuar_OP(final ActionEvent event) {
        ...
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                final PagosTDCnoPropiasConfirmController controller = new PagosTDCnoPropiasConfirmController();
                controller.mostrarTDCnopropiasConfirmData(InfoDatosTdcPropia.getInfoTdcProp());
    ...
    @FXML
    void selOtroValorPesos(final ActionEvent event) {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
