 ...
 * @author luis.cuervo
 */
public class InscripcionServicioClaveDinamicaPendienteValidacionController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        assert terminar_trx != null : "fx:id=\"terminar_trx\" was not injected: check your FXML file 'InscripcionServicioClaveDinamicaPendienteValidacion.fxml'.";
        assert titulosEvidente != null : "fx:id=\"titulosEvidente\" was not injected: check your FXML file 'InscripcionServicioClaveDinamicaPendienteValidacion.fxml'.";
    }
...
//        final TipoCteGdeOk tipoClte = new TipoCteGdeOk();
        ...
        try {
            ...
            /*final String RetornarTipoClienteGde = tipoClte.RetornarTipoClienteGde("01010",
             "ODA",
             "S",                                                                           
             enrolado.getTipo_mecanismo(),//datosSeguridad.getCambio_mecanismo(),
             "1",
             "S", 
             EstadoClave);*/
            ...
            tramaAFenix.append("S" + "%"); // ClaveSN
            tramaAFenix.append("00014%"); // EstadoOTP
            tramaAFenix.append("ODA%"); // tipoODA
            tramaAFenix.append(enrolado.getTipo_mecanismo() + "%"); // tipoODA // SMS O EML
            tramaAFenix.append("S%"); // Otp Antitramite
            tramaAFenix.append("1%"); // OTP Servicio
            tramaAFenix.append("N%"); // Tiene OTP
...
//            System.out.println("Datos:");
    ...
    public void mostrarFinInscripcionClaveDinamicaPendienteValidacion(final String menu, final int flujo, final int opcion) {
        try {
            Platform.runLater(new Runnable() {
                @Override
                public void run() {
                    ...
                    try {
                        ...
                        final URL location = getClass().getResource("/com/co/allus/vistas/InscripcionServicioClaveDinamicaPendienteValidacion.fxml");
