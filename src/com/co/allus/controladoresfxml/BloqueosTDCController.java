 ...
 */
public class BloqueosTDCController implements Initializable {
    /**
    ...
    private Service<ObservableList<modelSaldoTarjeta>> task = new GetTarjetasTask();
    ...
    void cancelarOP(final ActionEvent event) {
        try {
            BloqueosTDCController.cancelartarea.set(true);
        } catch (Exception ex) {
    ...
    void continuarOP(final ActionEvent event) {
        try {
            ...
            final BloqueoTDCConfirmController controller = new BloqueoTDCConfirmController();
            controller.mostrarBloqueosTDCconfirm(DatosTDCBloqueos.getDatabloqueo());
        } catch (Exception e) {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        BloqueosTDCController.cancelartarea.set(false);
    }

    public void mostrarBloqueosTDC(final String menu) {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                try {
                    final URL location = getClass().getResource("/com/co/allus/vistas/BloqueosTDC.fxml");
                    ...
                    task.setOnCancelled(new EventHandler<WorkerStateEvent>() {
                        ...
                        public void handle(WorkerStateEvent t) {
                            ...
                            gestorDoc.imprimir("cancelo la tarea BloqueoTDC -->" +  "  :" + gestorDoc.obtenerHoraActual());
                        }
                    });
                } catch (Exception e) {
                    gestorDoc.imprimir("Error en la aplicacion -->" + e.toString() + "  :" + gestorDoc.obtenerHoraActual());
            ...
            return new Task() {
                ...
                protected Object call() throws Exception {
                    ...
                    if (MarcoPrincipalController.newConsultaBloqTDc) {
                        try {
                            gestorDoc.imprimir(System.getProperties().getProperty("user.name") + "##" + "Envio a MQ LISTAR TDC = " + "##" + gestorDoc.obtenerHoraActual());
                            ...
                            try {
                                ...
                                Platform.runLater(new Runnable() {
                                    @Override
                                    public void run() {
                                        if (BloqueosTDCController.cancelartarea.get()) {
