 ...
 */
public class ParametrizacionAlertasFinController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        assert terminar_trx != null : "fx:id=\"terminar_trx\" was not injected: check your FXML file 'ParametrizacionAlertasFin.fxml'.";
    }

    public void motrarParametrizacionAlertasFin() {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                try {
                    final URL location = getClass().getResource("/com/co/allus/vistas/ParametrizacionAlertasFin.fxml");
