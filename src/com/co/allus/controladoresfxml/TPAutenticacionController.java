        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    dataTabla.add(new DataAutenticacion("¿Cuál es la fecha de expedición de su cédula?", fechaExpedicion));
                    dataTabla.add(new DataAutenticacion("Lugar de expedición de la cédula", datosCliente.getLugarExpedicion().toLowerCase().trim()));
