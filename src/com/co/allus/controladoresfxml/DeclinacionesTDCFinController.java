 ...
 */
public class DeclinacionesTDCFinController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        assert terminar_trx != null : "fx:id=\"terminar_trx\" was not injected: check your FXML file 'DeclinacionesTDCFin.fxml'.";
    }

    public void mostrarDeclinacionesTDCFinController() {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                try {
                    final URL location = getClass().getResource("/com/co/allus/vistas/DeclinacionesTDCFin.fxml");
...
//        } catch (Exception e) {
//            Logger.getLogger(DeclinacionesTDCController.class.getName()).log(Level.WARNING, null, e);
//        }
    }
}
