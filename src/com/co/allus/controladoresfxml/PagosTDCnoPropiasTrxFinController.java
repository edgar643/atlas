 ...
 */
public class PagosTDCnoPropiasTrxFinController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        assert comprobante != null : "fx:id=\"comprobante\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxFin.fxml'.";
        assert fecha_pago != null : "fx:id=\"fecha_pago\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxFin.fxml'.";
        assert franquicia != null : "fx:id=\"franquicia\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxFin.fxml'.";
        assert num_cuenta != null : "fx:id=\"num_cuenta\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxFin.fxml'.";
        assert tabla_Datos1 != null : "fx:id=\"tabla_Datos1\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxFin.fxml'.";
        assert tabla_Datos2 != null : "fx:id=\"tabla_Datos2\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxFin.fxml'.";
        assert tarjeta_pagada != null : "fx:id=\"tarjeta_pagada\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxFin.fxml'.";
        assert terminar_trx != null : "fx:id=\"terminar_trx\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxFin.fxml'.";
        assert tipo_cuenta != null : "fx:id=\"tipo_cuenta\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxFin.fxml'.";
        assert valor_pagado != null : "fx:id=\"valor_pagado\" was not injected: check your FXML file 'PagosTDCnoPropiasTrxFin.fxml'.";
        this.location = url;
        this.resources = rb;
    ...
    public void mostrarTrxPagoTDCnopropFin(final InfoDatosTdcPropia infoDatos) {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                ...
                try {
                    ...
                    final URL location = getClass().getResource("/com/co/allus/vistas/PagosTDCnoPropiasTrxFin.fxml");
                    ...
                    new ModalMensajes("Error en la aplicacion \n , es posible que el  pago se halla realizado correctamente , por favor no volver a intertalo e informar al area tecnica", "Error", ModalMensajes.MENSAJE_ERROR, ModalMensajes.MODAL_PAGOS_TRANSF_CTA_PROP);
