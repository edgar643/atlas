 ...
 */
public class TPRegeneracionConfirmController implements Initializable {
    ...
    private transient Service<Void> serviceRegeneracion;
    private static GestorDocumental docs = new GestorDocumental();

    @Override
    public void initialize(URL url, ResourceBundle rb) {
        assert progreso != null : "fx:id=\"progreso\" was not injected: check your FXML file 'TPRegeneracionConfirm.fxml'.";
        assert aceptar_op != null : "fx:id=\"aceptar_op\" was not injected: check your FXML file 'TPRegeneracionConfirm.fxml'.";
        assert cancelar_op != null : "fx:id=\"cancelar_op\" was not injected: check your FXML file 'TPRegeneracionConfirm.fxml'.";
        assert lblmensaje != null : "fx:id=\"lblmensaje\" was not injected: check your FXML file 'TPRegeneracionConfirm.fxml'.";
        this.location = url;
        this.resources = rb;
        ...
        try {
            if ("N".equalsIgnoreCase(Cliente.getCliente().getTipoClientePrepago())) {
                ...
                Platform.runLater(new Runnable() {
                    @Override
                    public void run() {
                        final TPRegeneracionController controller = new TPRegeneracionController();
            ...
            Logger.getLogger(TPRegeneracionConfirmController.class.getName()).log(Level.WARNING, null, e);
        }
    }
...
//            @Override
//            public void run() {
//                final TPRegeneracionFinController controller = new TPRegeneracionFinController();
//                controller.mostrarConfirmarRegeneracion();
//            }
//        });
//    }
    @FXML
    ...
    public Service<Void> aceptar_op() {
        serviceRegeneracion = new Service<Void>() {
            @Override
            protected Task<Void> createTask() {
                return new Task<Void>() {
                    ...
                    protected Void call() throws Exception {
                        ...
                        tramaBloqueoTDCP.append("850,068,");
                        tramaBloqueoTDCP.append(cliente.getRefid());
                        tramaBloqueoTDCP.append(",");
                        tramaBloqueoTDCP.append(AtlasConstantes.COD_REGENERACION_PREP);
                        tramaBloqueoTDCP.append(",");
                        if ("N".equalsIgnoreCase(Cliente.getCliente().getTipoClientePrepago())) {
                        ...
                        if ("N".equalsIgnoreCase(Cliente.getCliente().getTipoClientePrepago())) {
                            ...
                            tramaBloqueoTDCP.append("3");
                        }
                        tramaBloqueoTDCP.append(",");
                        tramaBloqueoTDCP.append(Cliente.getCliente().getTipoClientePrepago()); // variable
                        tramaBloqueoTDCP.append(",");
                        tramaBloqueoTDCP.append(DatosRegeneracionConfirm.getDataAct().getNumTarjsf());
                        tramaBloqueoTDCP.append(",");
                        tramaBloqueoTDCP.append(cliente.getContraseña());
                        tramaBloqueoTDCP.append(",~");

//                        System.out.println("TRAMA regeneración TDC prepago :" + tramaBloqueoTDCP.toString());

                        try {
                            docs.imprimir(System.getProperties().getProperty("user.name") + "##" + "Envio a MQ regeneracion prepago= " + "##" + docs.obtenerHoraActual());
//                            Respuesta = "850,"
//                                    + "003,"
//                                    + "000,"
...
//                            System.out.println("Respuesta TRAMA regeneración TDC :" + Respuesta);
                            ...
                            try {
                                docs.imprimir(System.getProperties().getProperty("user.name") + "##" + "envio ctg MQ regeneracion prepago = " + "##" + docs.obtenerHoraActual());
                                Respuesta = servicioSS.enviarRecibirServidor(AtlasConstantes.IP_MQ_DMZ_PRINCIPAL, AtlasConstantes.PUERTO_COM_MQ_DMZ, tramaBloqueoTDCP.toString());
                        ...
                        if ("000".equals(Respuesta.split(",")[2])) {
                            ...
                            Platform.runLater(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    final TPRegeneracionFinController controller = new TPRegeneracionFinController();
                                    controller.mostrarRegeneracionTDCFfin(DatosRegeneracionConfirm.getDataAct(), formatoFechabloqueo.format(new Date()));
                                }
                            });
...
//                                @Override
//                                public void run() {
//                                    new ModalMensajes(mensaje.isEmpty() ? "Su clave ha sido generada con éxito, \n ésta será entregada al contacto autorizado por su empresa" : mensaje, coderror, ModalMensajes.MENSAJE_INFORMACION, ModalMensajes.DEFAULT);
//                              
//                                }
//                            });
//                            
...
//                            }
        ...
        return serviceRegeneracion;

    }

    public void mostrarConfirmarRegeneracion(final DatosRegeneracionConfirm numtarj) {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                try {

                    final URL location = getClass().getResource("/com/co/allus/vistas/TPRegeneracionConfirm.fxml");
                    ...
                    if ("N".equalsIgnoreCase(datosCliente.getTipoClientePrepago())) {
                        ...
                        lblmensaje.setText("¿Está seguro de que desea generar la clave para la tarjeta " + numtarj.getTipoTarj() + "\n" + tarjeta + "?");
