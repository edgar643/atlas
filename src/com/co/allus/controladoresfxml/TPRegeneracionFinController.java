...
import com.co.allus.modelo.tpregeneracion.tablaFinRegeneracion;
 ...
 */
public class TPRegeneracionFinController implements Initializable {
    ...
    @FXML
    private TableView<tablaFinRegeneracion> tabla_datos;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        assert fechahora != null : "fx:id=\"fechahora\" was not injected: check your FXML file 'TPRegeneracionFin.fxml'.";
        assert lblmensaje != null : "fx:id=\"lblmensaje\" was not injected: check your FXML file 'TPRegeneracionFin.fxml'.";
        assert tabla_datos != null : "fx:id=\"tabla_datos\" was not injected: check your FXML file 'TPRegeneracionFin.fxml'.";
        assert terminar_trx != null : "fx:id=\"terminar_trx\" was not injected: check your FXML file 'TPRegeneracionFin.fxml'.";


        this.location = url;
        this.resources = rb;

        fechahora.setCellValueFactory(new PropertyValueFactory<tablaFinRegeneracion, String>("valor"));
    }
    ...
    public void mostrarRegeneracionTDCFfin(final DatosRegeneracionConfirm tarjeta, final String fecha) {
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    final URL location = getClass().getResource("/com/co/allus/vistas/TPRegeneracionFin.fxml");
                    ...
                    final TableView<tablaFinRegeneracion> tablaFinRegeneracion = (TableView<tablaFinRegeneracion>) root.lookup("#tabla_datos");
                    ...
                    if ("N".equalsIgnoreCase(datosCliente.getTipoClientePrepago())) {
                        ...
                        final String info = nombreC + "\nC.C: " + datosCliente.getId_cliente() + "\n" + DatosRegeneracionConfirm.getDataAct().getNumTarj();
                        cliente.setText("");
                    ...
                    mensaje.setText("Su clave ha sido generada con éxito, \nésta será entregada al contacto autorizado por su empresa");
                    tablaFinRegeneracion.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
                    /**
                     * se cargan los valores de la informacion del finpago
                     */
                    final ObservableList<tablaFinRegeneracion> datosreg = FXCollections.observableArrayList();
                    final tablaFinRegeneracion datostabla = new tablaFinRegeneracion(fecha);
                    datosreg.add(datostabla);
                    tablaFinRegeneracion.setItems(datosreg);
