 ...
 */
public class InactivarAlertasFinController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        assert terminar_trx != null : "fx:id=\"terminar_trx\" was not injected: check your FXML file 'InactivarAlertasFin.fxml'.";
    }

    public void mostrarInactivarAlertasFinController() {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                try {
                    final URL location = getClass().getResource("/com/co/allus/vistas/InactivarAlertasFin.fxml");
                    ...
                    try {
                        ...
                        Logger.getLogger(InactivarAlertasFinController.class.getName()).log(Level.WARNING, null, ex);
                    }
    ...
    void aceptar(ActionEvent event) {
        try {
            InactivarAlertasFinController.cancelartarea.set(true);
        } catch (Exception ex) {
            gestorDoc.imprimir("Error en la aplicacion -->" + ex.toString() + "  :" + gestorDoc.obtenerHoraActual());
        } finally {
            Platform.runLater(new Runnable() {
