 ...
 */
public class BusquedaConvPagosT extends Service<ObservableList<InfoTablaPagosTerceros>> {

    private String id;

    public BusquedaConvPagosT(String id) {
        this.id = id;
    }
                    ...
                    if (id.trim().isEmpty()) {
                        ...
                        synchronized (PagosATercerosInitController.pagos) {
                            ...
                            for (Iterator<InfoTablaPagosTerceros> it = PagosATercerosInitController.pagos.iterator(); it.hasNext();) {
                                ...
                                if (data.colCodConvenioProperty().getValue().equalsIgnoreCase(id) || data.colCodConvenioProperty().getValue().startsWith(id)) {
                                    DatosTabla.add(data);
