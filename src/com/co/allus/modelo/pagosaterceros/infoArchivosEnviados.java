 ...
 */
public class infoArchivosEnviados {

    public static infoArchivosEnviados infoarchenv = new infoArchivosEnviados();
    ...
    public infoArchivosEnviados(String nun_registro,
    ...
    private infoArchivosEnviados() {
    }

    public static infoArchivosEnviados getInfoarchenv() {
        return infoarchenv;
    }
