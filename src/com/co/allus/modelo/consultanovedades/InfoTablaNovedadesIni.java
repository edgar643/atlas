 ...
 */
public class InfoTablaNovedadesIni {
    ...
    private transient final SimpleDateFormat formatoHora = new SimpleDateFormat("kk:mm", Locale.getDefault());

    public InfoTablaNovedadesIni(String estado_servicio, String tipo_mec, String fecha, String hora, String canal) {
