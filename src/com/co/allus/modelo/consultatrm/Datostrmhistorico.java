 ...
 */
public class Datostrmhistorico {

    private static Datostrmhistorico datosTrmHistorico = new Datostrmhistorico();
    ...
    public static Datostrmhistorico getDatostrmhistorico() {
        return datosTrmHistorico;
    }

    public static void setDatostrmhistorico(Datostrmhistorico datosTrmHistorico) {
        Datostrmhistorico.datosTrmHistorico = datosTrmHistorico;
    }
}
