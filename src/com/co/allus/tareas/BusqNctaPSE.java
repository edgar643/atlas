 ...
 * @author alexander.lopez.o
 */
public class BusqNctaPSE extends Service<ObservableList<infoMovPSE>> {

    private String id;

    public BusqNctaPSE(final String id) {
        this.id = id;
    }
                    ...
                    if (id.trim().isEmpty()) {
                        ...
                        synchronized (MovRecaudosPSEController.registros) {
                            ...
                            for (Iterator<infoMovPSE> it = MovRecaudosPSEController.registros.iterator(); it.hasNext();) {
                                ...
                                if (data.getCuentaRecaudoadora().equalsIgnoreCase(id) || data.getCuentaRecaudoadora().startsWith(id)) {
                                    DatosTabla.add(data);
